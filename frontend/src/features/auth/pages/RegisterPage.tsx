...
import { getRegisterSchema, type RegisterFormValues } from "../schemas/authSchemas";
  ...
  return (
    <section className="mx-auto grid w-full max-w-6xl flex-1 items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
      <aside className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-xl shadow-slate-900/5 backdrop-blur sm:p-8">
        ...
        <p className="mt-4 text-base leading-7 text-slate-600">{t("auth.register.description")}</p>
        ...
        <form className="grid gap-5" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input
              ...
              type="text"
            />
            {errors.name ? <p className="mt-2 text-sm text-red-600" id="register-name-error">{errors.name.message}</p> : null}
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="email"
            />
            {errors.email ? <p className="mt-2 text-sm text-red-600" id="register-email-error">{errors.email.message}</p> : null}
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="password"
            />
            {errors.password ? <p className="mt-2 text-sm text-red-600" id="register-password-error">{errors.password.message}</p> : null}
          </div>
          ...
          <p className="text-sm text-slate-600">
            ...
            <Link className="font-semibold text-emerald-700 hover:text-emerald-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-emerald-600" to="/login">
